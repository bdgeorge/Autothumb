...
$PHPTHUMB_CONFIG['cache_source_enabled']   = false;                               //TODO: BGE check this // if true, source images obtained via HTTP are cached to $PHPTHUMB_CONFIG['cache_source_directory']
